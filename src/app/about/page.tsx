  ...
  return (
    <div className="space-y-12">
      <section className="text-center py-12 bg-gradient-to-r from-primary/10 via-background to-accent/10 rounded-lg">
        <h1 className="text-4xl font-bold tracking-tight text-primary sm:text-5xl">About PrepWise</h1>
      ...
      <section className="text-center py-12">
        ...
        <p className="text-muted-foreground max-w-xl mx-auto">
          PrepWise is more than just a test prep tool; it's your dedicated partner in achieving academic excellence.
        </p>
      </section>
    </div>
  );
